...
@section('js')
    <!-- dayjs para formato de fecha -->
    <script src="https://cdn.jsdelivr.net/npm/dayjs@1/dayjs.min.js"></script>
    <script>
        var editRoute = "{{ route('admin.holidays.edit', ['holiday' => 'ID']) }}";
        var destroyRoute = "{{ route('admin.holidays.destroy', ['holiday' => 'ID']) }}";
        var createRoute = "{{ route('admin.holidays.create') }}";
        var indexRoute = "{{ route('admin.holidays.index') }}";
        ...
        $('#btnNuevo').click(function() {
            $.get(createRoute, function(response) {
                $('.modal-title').html("Nuevo Feriado");
        ...
        $('#datatable').on('click', '.btnEditar', function() {
            ...
            $.get(url, function(response) {
                $('.modal-title').html("Editar Feriado");
                $('#ModalCenter .modal-body').html(response);
                $('#ModalCenter').modal('show');
